...
--changeset MikeO:CreatePROC_add_job_history endDelimiter:/ splitStatements:false runOnChange:true labels:STOLO
...
END;
/
--rollback DROP PROCEDURE add_job_history;

--changeset AmyS:createTrigger_update_job_history splitStatements:false labels:STOLO
...
--rollback DROP TRIGGER update_job_history
